;(function () {
	...
	var faqsAccordion = function() {
		...
		var faqAcc = $('.faq-accordion h3').not('.nested-accordion h3');
		...
		faqAcc.on('click', function(event){
			...
			$('.faq-accordion').find('.faq-body.first-level').slideUp(400, 'easeInOutExpo');

			if ( !$this.closest('.faq-accordion').find('.faq-body.first-level').is(':visible')) {
				$this.closest('.faq-accordion').addClass('active');
				$this.closest('.faq-accordion').find('.faq-body.first-level').slideDown(400, 'easeInOutExpo');
			} else {
				$this.closest('.faq-accordion').removeClass('active');
				$this.closest('.faq-accordion').find('.faq-body.first-level').slideUp(400, 'easeInOutExpo');
			}
		...
		var faqAcc2 = $('.faq-accordion h4.nested');

		// Click
		faqAcc2.on('click', function(event){
			var $this2 = $(this);
			
			$('.nested-accordion').removeClass('active');
			$('.nested-accordion').find('.faq-body.second-level').slideUp(400, 'easeInOutExpo');

			if ( !$this2.closest('.nested-accordion').find('.faq-body.second-level').is(':visible')) {
				$this2.closest('.nested-accordion').addClass('active');
				$this2.closest('.nested-accordion').find('.faq-body.second-level').slideDown(400, 'easeInOutExpo');
			} else {
				$this2.closest('.nested-accordion').removeClass('active');
				$this2.closest('.nested-accordion').find('.faq-body.second-level').slideUp(400, 'easeInOutExpo');
			}


			setTimeout(function(){
				// alert($this2.closest('.faq-accordion.active').innerHeight());
				$('html, body').animate({
			        scrollTop: $this2.closest('.nested-accordion.active').offset().top - 90
			    }, 500);
			}, 700);
